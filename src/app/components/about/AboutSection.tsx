...
export default function AboutSection() {
    ...
    return (
        <section id="about" className="py-10 max-w-5xl mx-auto">
            ...
            <JourneyCards/>
            <div className="mt-3">
                <Link href="/" className="mb-6 flex items-center group" onClick={handleLinkClick}>
            ...
            <Link href="https://www.16personalities.com/profiles/a194f45c39e69" className="mb-6 flex items-center group">
                <span className="text-sm underline group-hover:no-underline">
